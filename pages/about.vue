<template lang="pug">
  #about
    ...
    section.dept-container.stages
      ...
      p 約半年間にも及ぶ準備の集大成である各ステージのパフォーマンスを是非お楽しみください!
      h3 Stages
      .image
    section.dept-container.design
      h2
        img(src="~/assets/icon/DeptIconName-Design.svg" alt="デザイン課")
      p 文化祭をデザインしています。文化委員会で最も人的規模の小さい課ですが担当する領域は広く、文化祭ロゴの制作からパンフレット・灘校グッズや文化祭PVなどの動画、部活ポスターやサインシステム、今ご覧頂いているこのWebサイトのデザイン/実装まで全てを一貫して実施しています。校内各所のデザイン課の制作物にもご注目ください。
      h3 Design
      .image
    section.dept-container.general-affairs
      h2
        img(src="~/assets/icon/DeptIconName-GeneralAffairs.svg" alt="庶務課")
      p 庶務課は主に、文化祭に出展するクラブ・サークルから文化祭に必要な情報を回収し、それを基にクラブ・サークルと打ち合わせを進めています。部屋割りを決めるところから始まり、電力や印刷物について打ち合わせをするなど文化祭を盛り上げるクラブ・サークルを影から支えています。また、明確な業務が規定されている装飾・ステージ・デザイン・総務のどれにも該当しない広報や受付なども庶務課が担当しています。
      .image
      h3 General Affairs
</template>
