<template lang="pug">
  #about
    ...
    section.dept-container.design
      ...
      p 文化祭をデザインしています。文化委員会で最も人的規模の小さい課ですが担当する領域は広く、文化祭ロゴの制作からパンフレット・灘校グッズや文化祭PVなどの動画、部活ポスターやサインシステム、今ご覧頂いているこのWebサイトのデザイン/実装まで全てを一貫して実施しています。校内のデザイン課の制作物にもご注目ください。
      h3 Design
      .image
